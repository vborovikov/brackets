  ...
  ""elements"": [
    ...
    ""test"": ""no one will find me""
        ...
        public void EvaluateIndexerOnObjectWithError()
        {
            ...
            Assert.ThrowsException<JsonException>(() => o.SelectToken("[1]", true),
        ...
        public void EvaluateWildcardIndexOnObjectWithError()
        {
            ...
            Assert.ThrowsException<JsonException>(() => o.SelectToken("[*]", true),
        ...
        public void EvaluateMultipleResultsError()
        {
            ...
            Assert.ThrowsException<JsonException>(() => a.SelectToken("[0, 1]"),
        ...
        public void EvaluatePropertyOnArrayWithError()
        {
            ...
            Assert.ThrowsException<JsonException>(() => a.SelectToken("BlahBlah", true),
        ...
        public void EvaluateNoResultsWithMultipleArrayIndexes()
        {
            ...
            Assert.ThrowsException<JsonException>(() => a.SelectToken("[9,10]", true),
        ...
        {
            var o = JsonDocument.Parse(@"{ ""Blah"": 1 }");
            Assert.ThrowsException<JsonException>(() => o.SelectToken("Missing", true),
        ...
        public void EvaluateMissingPropertyIndexWithError()
        {
            ...
            Assert.ThrowsException<JsonException>(() => o.SelectToken("['Missing','Missing2']", true),
                "Property 'Missing' does not exist on JsonDocument.");
        }
        ...
        public void EvaluateMultiPropertyIndexOnArrayWithError()
        {
            ...
            Assert.ThrowsException<JsonException>(() => a.SelectToken("['Missing','Missing2']", true),
        ...
        public void EvaluateArraySliceWithError()
        {
            ...
            Assert.ThrowsException<JsonException>(() => a.SelectToken("[99:]", true),
                "Array slice of 99 to * returned no results.");

            Assert.ThrowsException<JsonException>(() => a.SelectToken("[1:-19]", true),
                "Array slice of 1 to -19 returned no results.");

            Assert.ThrowsException<JsonException>(() => a.SelectToken("[:-19]", true),
                "Array slice of * to -19 returned no results.");

            a = JsonDocument.Parse("[]");

            Assert.ThrowsException<JsonException>(() => a.SelectToken("[:]", true),
        ...
        public void EvaluateArrayOutOfBoundsIndxerWithError()
        {
            ...
            Assert.ThrowsException<JsonException>(() => a.SelectToken("[1000].Ha", true),
