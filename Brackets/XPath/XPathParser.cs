namespace Brackets.XPath
{
    ...
    public class XPathParser<TNode>
    {
        ...
        */
        ...
        private TNode ParseStep()
        {
            ...
            {                  // '.'
                ...
                {
                    throw this.scanner.PredicateAfterDotException();
                }
            }
            ...
            {        // '..'
                ...
                if (LexKind.LBracket == this.scanner.Kind)
                {
                    throw this.scanner.PredicateAfterDotDotException();
                }
            }
            else
            {                                            // (AxisName '::' | '@')? NodeTest Predicate*
                ...
                switch (this.scanner.Kind)
                {
                    ...
                    default:
                        throw this.scanner.UnexpectedTokenException(this.scanner.RawValue);
                }
        ...
        */
        ...
        private TNode ParseNodeTest(XPathAxis axis)
        {
            ...
            InternalParseNodeTest(this.scanner, axis, out var nodeType, out var nodePrefix, out var nodeName);
        ...
        */
        ...
        #endregion Location paths and node tests
        ...
        */
        ...
        private TNode ParseSubExpr(int callerPrec)
        {
            ...
            if (this.scanner.Kind == LexKind.Minus)
            {
                ...
                this.scanner.NextLex();
                opnd = this.builder.Operator(op, ParseSubExpr(opPrec), default(TNode));
            }
            else
            {
                opnd = ParseUnionExpr();
